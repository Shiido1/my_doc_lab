class OrderByIdResponseModel {
  Headers? headers;
  Original? original;
  dynamic exception;

  OrderByIdResponseModel({this.headers, this.original, this.exception});

  OrderByIdResponseModel.fromJson(Map<String, dynamic> json) {
    headers =
