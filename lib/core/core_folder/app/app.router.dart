...
class DoctorChatScreenArguments {
  ...
  final _i21.GetMessageIndexResponseModel? messageModel;

  final _i22.GetListOfDoctorsAppointmentModel? app;

  final _i23.Data? data;
...
class DoctorAppointmentDetailSceenArguments {
  ...
  final _i22.GetListOfDoctorsAppointmentModel? appointment;
...
class UserPrescriptionDetailScreenArguments {
  ...
  final _i25.ViewDoctorsPrescriptionModel? view;
...
extension NavigatorStateExtension on _i26.NavigationService {
  ...
  Future<dynamic> navigateToDoctorChatScreen({
    _i20.Key? key,
    required String? id,
    required _i21.GetMessageIndexResponseModel? messageModel,
    required _i22.GetListOfDoctorsAppointmentModel? app,
    required _i23.Data? data,
  ...
  Future<dynamic> navigateToDoctorAppointmentDetailSceen({
    _i20.Key? key,
    _i22.GetListOfDoctorsAppointmentModel? appointment,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
  ...
  Future<dynamic> navigateToUserPrescriptionDetailScreen({
    _i20.Key? key,
    required _i25.ViewDoctorsPrescriptionModel? view,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
