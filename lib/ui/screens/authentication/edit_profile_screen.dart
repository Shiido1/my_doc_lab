...
import 'package:doc_lab_pharm/core/connect_end/model/update_user_entity_model.dart';
      ...
      onViewModelReady: (model) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
          ...
          lastnameTextController.text =
              model.getUserResponseModel?.data?.lastName ?? '';
          addressController.text =
              model.getUserResponseModel?.data?.address ?? '';

          phoneController.text = model.getUserResponseModel?.data?.phone ?? '';
          emailTextController.text =
              model.getUserResponseModel?.data?.email ?? '';
        });
      },
