...
import 'video_chat_agora/lab_tech_video_chat_screen.dart';

// ignore: must_be_immutable
class LabTechChatScreen extends StatefulWidget {
  LabTechChatScreen({
    super.key,
    required this.id,
  ...
  @override
  State<LabTechChatScreen> createState() => _LabTechChatScreenState();
}

class _LabTechChatScreenState extends State<LabTechChatScreen> {
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: TextView(
                                text:
                                    widget.appOrder?.user?.firstName
                                        ?.capitalize() ??
                              ...
                              child: GestureDetector(
                                onTap:
                                    () => Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder:
                                            (context) => LabTechVideoChatScreen(
                            ...
                            child: Form(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  SizedBox(width: 4.w),
                                  widget.appOrder != null && isJustInitiated ||
