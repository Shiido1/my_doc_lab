...
class LaboratoryOrderScreen extends StatefulWidget {
  const LaboratoryOrderScreen({super.key});

  @override
  State<LaboratoryOrderScreen> createState() => _LaboratoryOrderScreenState();
}

class _LaboratoryOrderScreenState extends State<LaboratoryOrderScreen> {
  String tab = 'All';
