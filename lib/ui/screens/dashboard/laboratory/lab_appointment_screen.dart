...
class LaboratoryAppointmentScreen extends StatefulWidget {
  const LaboratoryAppointmentScreen({super.key});

  @override
  State<LaboratoryAppointmentScreen> createState() =>
      _LaboratoryAppointmentScreenState();
}

class _LaboratoryAppointmentScreenState
    extends State<LaboratoryAppointmentScreen> {
  String tab = 'All';
                        ...
                        (i) => GestureDetector(
                          onTap:
                              () => Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder:
                                      (context) => LabOrderPatientDetailSceen(),
                                ),
                              ),
                          child: Container(
                            padding: EdgeInsets.symmetric(
