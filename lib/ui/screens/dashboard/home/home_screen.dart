...
import 'package:doc_lab_pharm/ui/screens/dashboard/settings/profile_screen_one.dart';
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                            ...
                            children: [
                              ...
                              TextView(
                                text:
                                    !_isTapped
                                        ? '*******'
                                        : '${getCurrency()}${oCcy.format(double.parse('${model.getUserResponseModel?.data?.wallets?.balance ?? '0.0'}'))}',
                                textStyle: TextStyle(
                                  color: AppColor.white,
                ...
                SizedBox(height: 20.h),
                TextFormWidget(
                  label: 'Search for doctors, specialties,',
                  border: 10,
                  isFilled: true,
